...
REQUIRED = ['matplotlib==3.9.0', 'voila==0.5.7', 'ipywidgets==8.1.3', 'pandas==1.5.3', 'IPython','Ipympl', 'jinja2','nemophoto>=1.3.1', 'ipykernel==6.29.5', 'numpy==1.26.4', 'colour-science==0.4.6']
